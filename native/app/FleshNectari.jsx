...
export default function FleshNectari() {
    const navigation=useNavigation();
    return (
      <View className='bg-rose-400 flex-1 ' >
          <SafeAreaView>
        ...
        <Image source={require('../assets/images/clothes.png')} style={{height:270,width:320}} />
        </View>
        </SafeAreaView>
        ...
        <View className='bg-rose-400 rounded-xl'>
      <Cart />
      </View>
        </View>
      </View>
